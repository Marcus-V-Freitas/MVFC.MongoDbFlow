    ...
    .Does(() =>
{
    ...
    var exitCode = StartProcess("dotnet", "restore MVFC.MongoDbFlow.slnx");
    ...
    .Does(() =>
{
    ...
    var exitCode = StartProcess("dotnet", "build MVFC.MongoDbFlow.slnx --configuration Release --no-restore");
...
Task("Test-Coverage")
    ...
    .Does(() =>
{
    var testProject = "./tests/MVFC.MongoDbFlow.Tests/MVFC.MongoDbFlow.Tests.csproj";
    ...
    var rgCode = StartProcess(rgPath, $"-reports:\"{reportArgs}\" -targetdir:\"{reportDir}\" -reporttypes:\"Html;Cobertura;MarkdownSummaryGithub\" -assemblyfilters:\"+MVFC.MongoDbFlow*\" -classfilters:\"-*.Tests.*;-*.Playground.*\"");
